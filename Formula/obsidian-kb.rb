class ObsidianKb < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/dgalichet/obsidian-kb/releases/download/v0.1.2/obsidian-kb-aarch64-apple-darwin.tar.gz"
      sha256 "0c6e344a12ef5bfbc043ce787248233dab08df04c10cc46d6d2a667702dc907b"
    end
  end
